                ...
                {[
                  ...
                  <div key={label} className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      {href ? (
                        <a href={href} className="text-slate-300 hover:text-brand-gold transition-colors text-sm font-medium">
                          {value}
                        </a>
                      ) : (
            ...
            {submitted ? (
              <div className="h-full flex flex-col items-center justify-center text-center p-12 bg-brand-card border border-green-500/20 rounded-2xl">
                ...
                <p className="text-slate-400">
                  Thank you for getting in touch. We&apos;ll be back to you within one business day with your free SEO audit.
                </p>
              </div>
            ) : (
              <form
              ...
              >
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                  ...
                  <div>
                    <label htmlFor="website" className="block text-sm font-medium text-slate-300 mb-2">Your Website</label>
                    <input
                ...
                <div>
                  <label htmlFor="message" className="block text-sm font-medium text-slate-300 mb-2">Tell Us About Your Business *</label>
                  <textarea
                ...
                >
                  {loading ? (
                    ...
                    <>Send Message &amp; Get Free Audit<Send className="w-4 h-4" /></>
                  )}
                </button>
